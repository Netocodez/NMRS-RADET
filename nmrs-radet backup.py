...
root = tk.Tk()
root.title("NETO's NMRS TO RADET CONVERTER")
root.geometry("600x300")
root.config(bg="#f0f0f0")

# Adding a Button to the Window
convert_button = tk.Button(root, text="SELECT FILE & CONVERT", command=nmrsRadet, font=("Helvetica", 14), bg="#4caf50", fg="#ffffff")
...
text.pack(pady=1)
text3 = tk.Label(root, text="you will be prompted to select the NMRS Linelist and the location you want to save the converted file")
text3.pack(pady=1)
