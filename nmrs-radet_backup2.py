...
option_menu = tk.OptionMenu(select_frame, selected_option, "NMRS-ART-LINEIST TO RADET (APPENDS CMG AND PATIENT ID) ▼", "NMRS-ART-LINEIST TO RADET (ONLY CONVERTS TO RADET)", "Option 3")
